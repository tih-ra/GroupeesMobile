...
//@interface GroupeesObject : NSObject
//@end

@interface GroupeesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GroupeesObject class]])
		{
			for (NSString *key in [[(GroupeesObject*)o modules] allKeys])
			{
