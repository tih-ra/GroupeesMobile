...
// in simulator we redefine to format for Groupees Developer console
...
{\
	NSString * exceptionName = [@"org.groupees." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.groupees";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIGroupeesNativeItemNone = -1, 
	UIGroupeesNativeItemSpinner = -2,
	UIGroupeesNativeItemProgressBar = -3,
	
	UIGroupeesNativeItemSlider = -4,
	UIGroupeesNativeItemSwitch = -5,
	UIGroupeesNativeItemMultiButton = -6,
	UIGroupeesNativeItemSegmented = -7,
	
	UIGroupeesNativeItemTextView = -8,
	UIGroupeesNativeItemTextField = -9,
	UIGroupeesNativeItemSearchBar = -10,
	
	UIGroupeesNativeItemPicker = -11,
	UIGroupeesNativeItemDatePicker = -12,
	
	UIGroupeesNativeItemInfoLight = -13,
	UIGroupeesNativeItemInfoDark = -14,
	
	UIGroupeesNativeItemDisclosure = -15,
	
	UIGroupeesNativeItemContactAdd = -16
};
