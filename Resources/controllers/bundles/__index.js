...
// create the rest of the rows
   ...
   var photo = Ti.UI.createView({
		backgroundImage:'../../images/tmp/bundle1.png',
		top:5,
		left:10,
		width:50,
		height:50,
	...
	var comment = Ti.UI.createLabel({
		...
		width:250,
		clickName:'comment',
		text:'A Pay What You Want ($1 min) music + charity campaign involving Klaypex and Feed Them With Music Charity.'
	});
	row.add(comment);
 ...
 var photo = Ti.UI.createView({
		backgroundImage:'../../images/tmp/bundle2.png',
		top:5,
		left:10,
		width:50,
		height:50,
	...
	var comment = Ti.UI.createLabel({
		...
		width:250,
		clickName:'comment',
		text:'Get 5 great games + great music + great incentives + feed the hungry!'
	});
	row.add(comment);
